            ...
            <div class="row d-inline-flex">
                ...
                <div class="mb-4 px-1">
                    <div class="card" style="max-height: 400px;">
                        <img src="<?php echo ABSOLUTE_PATH; ?>images/articles/thumbnails/<?php echo $article->preimage_arti; ?>" alt="<?php echo $article->name_arti; ?>" class="rounded-circle mx-auto" style="width: 200px; height:200px">
                        ...
                        <div class='card-footer'>
                            <div class="text-muted clearfix text-uppercase">
                                ...
                                <a href="<?php echo BASE_PATH; ?>/articles-by-user/<?php echo $article->user_arti; ?>"><span class="badge badge-primary float-right mr-n1"><small><?php echo $article->name_user; ?></small></span></a>
                            </div>
                        </div>
                    </div>
                </div><!-- /.blog-post -->
